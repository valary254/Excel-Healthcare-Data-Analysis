...
An end-to-end analysis of 55,500+ patient records covering data cleaning, pivot table analysis, an interactive KPI dashboard, and documented business recommendations, built entirely in Excel 2019.
...
[![Dashboard Preview](Healthcare.PNG)](https://github.com/valary254/Excel-Healthcare-Data-Analysis/blob/main/Healthcare.PNG)
...
- Middle-aged patients (22 to 81) account for the majority of admissions, averaging 8,100 patients per age group, while extreme age groups show significantly lower admission rates
...
3. **Age-Targeted Healthcare Programs:** Since middle-aged patients (22 to 81) make up the majority of admissions, hospitals should invest in preventive programs targeting this group to reduce future admissions
...
**Valary Shikanda** is an IT Support Specialist and Freelance Data Analyst based in Kenya, passionate about turning raw data into clear, actionable insights using Excel, SQL, and Power BI.
